...
import { OnsiteSupportRequestSection } from './ceremony/OnsiteSupportRequestSection';
import type {
  BillingPlanSummary,
  CartLineSummary,
 ...
 */
type EditTab = 'info' | 'billing' | 'customerQuote' | 'inquiries' | 'onsiteSupportRequests';
...
export const UserCeremonyEdit: FC = () => {
  ...
  return (
    <div>
      ...
      <div hidden={activeTab !== 'onsiteSupportRequests'}>
        {organizationId && ceremonyId && (
          <OnsiteSupportRequestSection organizationId={organizationId} ceremonyId={ceremonyId} />
        )}
      </div>
