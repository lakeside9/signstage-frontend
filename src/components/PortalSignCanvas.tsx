          ...
          return (
            <Fragment key={field.id}>
              <Rect
                ...
                width={fieldWidth}
                height={fieldHeight}
                stroke={field.isMine ? '#ef4444' : 'rgba(107, 114, 128, 0.9)'}
              ...
              {hasLabel && (
                <>
                  <Rect
                    ...
                    fill={field.isMine && field.isActive && field.canSign ? '#dc2626' : field.isMine ? '#ffffff' : 'rgba(255, 255, 255, 0.7)'}
                    stroke={field.isMine ? '#b91c1c' : '#9ca3af'}
                  ...
                  <Text
                    ...
                    fontStyle="bold"
                    fill={field.isMine && field.isActive && field.canSign ? '#ffffff' : field.isMine ? '#b91c1c' : '#4b5563'}
                    listening={canClick}
                    onClick={handleFieldClick}
                    onTap={handleFieldClick}
                    onMouseEnter={() => canClick && setCursor('pointer')}
