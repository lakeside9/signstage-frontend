  ...
  ko: {
    translation: {
      ...
      navigation: {
        ...
        documentVerification: '진위여부 검증하기', subscriptionMargin: '구독·마진 관리',
        billingPlans: '과금 플랜', optionalFeatures: '선택옵션', capacityAddOns: '용량 추가구매',
        unitProducts: '단위 상품', effects: '이벤트 효과',
        demoCeremonies: '데모 행사 관리', demoConfigs: '체험 데모 URL 관리',
        groupMembers: '회원·파트너 관리', groupBilling: '과금·카탈로그 관리',
        groupPurchase: '구매·할인 관리', groupDemo: '데모 관리', groupSystem: '시스템',
        permissionManagement: '권한 관리', menuManagement: '메뉴 관리',
        subscriptionPlans: '구독 플랜 카탈로그', subscriptionRequests: '구독 요청 관리',
        groupSupport: '고객지원 관리', faqs: 'FAQ', announcements: '공지사항',
        ceremonyInquiries: '행사 문의 관리', onsiteSupportRequests: '플랫폼 운영사 현장지원 요청 관리',
      },
      permission: {
        management: '권한 관리',
        action: {
          ...
          ceremonyCreate: '행사 등록', ceremonyManage: '행사 관리',
          memberManage: '조직 멤버 관리', companyInfoEdit: '회사정보 수정',
          customerQuoteManage: '고객 견적 관리', marginPolicyManage: '재판매 마진 정책 관리',
          effectManage: '이벤트 효과 관리', partnerMemberControl: '파트너 멤버 관리',
          partnerRequestReview: '파트너 등록 요청 승인/반려', subscriptionRequestReview: '구독 요청 승인/반려',
          faqManage: 'FAQ 등록/수정/삭제', announcementManage: '공지사항 등록/수정/삭제',
          ceremonyInquiryManage: '행사 문의 답변/종료',
          onsiteSupportRequestManage: '플랫폼 운영사 현장지원 요청 견적 입력',
        },
      },
      auth: {
  ...
  en: {
    translation: {
      ...
      navigation: {
        ...
        documentVerification: 'Document verification', subscriptionMargin: 'Subscriptions and margins',
        billingPlans: 'Billing plans', optionalFeatures: 'Optional features', capacityAddOns: 'Capacity add-ons',
        unitProducts: 'Unit products', effects: 'Event effects',
        demoCeremonies: 'Demo ceremonies', demoConfigs: 'Demo URLs',
        groupMembers: 'Users and partners', groupBilling: 'Billing and catalog',
        groupPurchase: 'Purchases and discounts', groupDemo: 'Demos', groupSystem: 'System',
        permissionManagement: 'Permission management', menuManagement: 'Menu management',
        subscriptionPlans: 'Subscription plan catalog', subscriptionRequests: 'Subscription requests',
        groupSupport: 'Support', faqs: 'FAQ', announcements: 'Announcements',
        ceremonyInquiries: 'Ceremony inquiries', onsiteSupportRequests: 'Platform onsite support requests',
      },
      permission: {
        ...
        action: {
          ...
          ceremonyCreate: 'Create ceremonies', ceremonyManage: 'Manage ceremonies',
          memberManage: 'Manage organization members', companyInfoEdit: 'Edit company information',
          customerQuoteManage: 'Manage customer quotes', marginPolicyManage: 'Manage resale margin policies',
          effectManage: 'Manage event effects', partnerMemberControl: 'Manage partner members',
          partnerRequestReview: 'Approve/reject partner requests', subscriptionRequestReview: 'Approve/reject subscription requests',
          faqManage: 'Create/edit/delete FAQs', announcementManage: 'Create/edit/delete announcements',
          ceremonyInquiryManage: 'Reply to/close ceremony inquiries',
          onsiteSupportRequestManage: 'Quote platform onsite support requests',
        },
      },
      auth: {
